...
<!-- DON NOT REMOVE THIS CopyRight Information!! By www.gongzi.me -->
...
<a href="javascript:grin(':neutral:')"><img src="<?php bloginfo('template_directory'); ?>/images/smilies/icon_neutral.gif" alt="smiley28" width="18" height="16"/></a>
<a href="javascript:grin(':cry:')"><img src="<?php bloginfo('template_directory'); ?>/images/smilies/icon_cry.gif" alt="smiley29"  width="18" height="16"/></a>
<a href="javascript:grin(':mrgreen:')"><img src="<?php bloginfo('template_directory'); ?>/images/smilies/icon_mrgreen.gif" alt="smiley30"  width="18" height="16"/></a></div>