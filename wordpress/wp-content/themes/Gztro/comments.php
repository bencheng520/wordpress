...
<div id="author_info">
	...
	<label for="author"><small>姓名:</small><?php if ($req) _e(" "); ?></label></p>
	<p><input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" tabindex="2"/>
	<label for="email"><small>邮箱:</small><?php if ($req) _e(" "); ?></label></p>
...
<input name="submit" type="submit" id="submit" tabindex="5" value="确认提交（Ctrl+Enter / Alt+S）" /> &nbsp;<a href="http://www.gongzi.org/gravatar.html" target="_blank" >没有头像？点此设置</a></font>
</div>
